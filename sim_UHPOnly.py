...
if __name__ == '__main__':
    ...
    parser.add_argument("--alpha_shape", type=str, help="Shape parameters for wbl", default=3)
    parser.add_argument("--beta_scale", type=str, help="bandwidth for the kernel", default=2)
